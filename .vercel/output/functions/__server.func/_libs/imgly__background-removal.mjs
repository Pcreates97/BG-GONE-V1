...
var getOrt = async (useWebGPU) => {
	...
	if (useWebGPU) ort = (await import("./onnxruntime-web.mjs").then((n) => n.t)).default;
	else ort = (await import("./onnxruntime-web.mjs").then((n) => n.n)).default;
	return ort;
};
