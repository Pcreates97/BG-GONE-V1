...
var Tensor$1 = class {
	...
	*/
	constructor(arg0, arg1, arg2) {
		...
		if (typeof arg0 === "object" && "location" in arg0) {
			...
			if (typeof arg0 === "string") {
				...
				if (arg0 === "string") {
					...
					if (Array.isArray(arg1)) if (arg0 === "float16" && typedArrayConstructor === Uint16Array || arg0 === "uint4" || arg0 === "int4") throw new TypeError(`Creating a ${arg0} tensor from number array is not supported. Please use ${typedArrayConstructor.name} as data.`);
					...
					else if (arg1 instanceof Uint8ClampedArray) if (arg0 === "uint8") data = Uint8Array.from(arg1);
		...
		if (this.cpuData && size !== this.cpuData.length) if ((type === "uint4" || type === "int4") && Math.ceil(size / 2) === this.cpuData.length) {} else throw new Error(`Tensor's size(${size}) does not match data length(${this.cpuData.length}).`);
		this.type = type;
		this.dims = dims;
		this.size = size;
	}
